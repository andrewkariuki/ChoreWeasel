                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="user-task">
                                            ...
                                            <div class="usertask badge badge-info p-1 text-white">
                ...
                <div class="adminactions">
                    ...
                    <div class="adminactions_body text-center">
                        ...
                        <div class="verify-user d-inline-block p-2">
                            <form action="{{ url('/admin/verify/tasker/'.$user->name.'/'.$user->id) }}" method="post" >
                                @csrf
                                @method('put')
                        ...
                        <div class="ban-unban-user d-inline-block p-2">
                            ...
                            <form action="{{ url('/admin/ban/tasker/'.$user->name.'/'.$user->id) }}" method="post" class="d-inline-block">
                                @csrf
                                @method('put')
                                <button type="submit" class="btn btn-danger">Ban User</button>
                            </form>
                            @else
                            <form action="{{ url('/admin/liftban/tasker/'.$user->name.'/'.$user->id) }}" method="post" class="d-inline-block">
                                @csrf
                                @method('put')
